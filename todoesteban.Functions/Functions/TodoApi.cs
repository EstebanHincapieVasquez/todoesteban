...
using todoesteban.Common.Models;
using todoesteban.Common.Responses;
using todoesteban.Functions.Entities;

namespace todoesteban.Functions.Functions
{
    public static class TodoApi
    {
            ...
            ILogger log)
        {
            ...
            string message = "Received all todos";
            log.LogInformation(message);
